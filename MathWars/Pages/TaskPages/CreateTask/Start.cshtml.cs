...
namespace MathWars.Pages.TaskPages.CreateTask
{
    ...
    public class StartModel : PageModel
    {
        ...
        public string PageSessionName = "CreateTask";
        ...
        public async Task<IActionResult> OnPostStep4()
        {
            ...
            if (isStep4Valid())
            {
                var isTaskCreated = await _taskCreatorService.CreateTaskAsync(TaskAnswersAndDifficulty, PageSessionName);
